...
The board is the current working context, not a changelog. Default to adaptive strictness: keep the active board short and high-signal, with only one Goal plus items that would meaningfully change future behavior if forgotten.
